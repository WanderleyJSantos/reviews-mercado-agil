...
for index, review in reviews.iterrows():
  ...
  print(f'Processando arquivo de áudio do review {reviewer_id} de {reviewer_email}...')
  arquivo_audio = genai.upload_file(path=f'audio/{review_audio}')
  prompt = 'Transcreva de maneira clara e detalhada o arquivo de áudio em anexo.'
  ...
  with open(f"transcricoes-audio/{reviewer_id}.txt", "w", encoding="utf-8") as arquivo:
    print(f'Salvando transcrição do arquivo de áudio do review {reviewer_id} de {reviewer_email}...')
